...
const ETFStatement = () => {
  ...
  const handleFetch = () => {
    setRows([
      { empNo:'E001', name:'John Doe', nic:'881234567V', net: 46084, threePercent: 1383 },
    ]);
  };
  ...
  return (
    <div className="space-y-6">
      <div className="bg-white p-6 rounded-lg shadow-md">
        <h3 className="text-lg font-semibold mb-4">ETF Statement</h3>
      ...
      <div className="bg-white p-6 rounded-lg shadow-md overflow-auto">
        <table className="min-w-[900px] divide-y divide-gray-200">
          <thead className="bg-gray-50">
            <tr>
              {['Emp no','Name','NIC','Net salary','3%'].map(h=> (
          ...
          <tbody className="divide-y divide-gray-100">
            {rows.map((r,i)=> (
              <tr key={i} className="hover:bg-gray-50">
                ...
                <td className="px-3 py-2 text-sm">{num(r.threePercent)}</td>
              </tr>
            ))}
          </tbody>
        </table>
